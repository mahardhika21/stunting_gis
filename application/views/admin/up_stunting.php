                ...
                <div class="col-sm-10 offset-1">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form method="post" action="<?php echo site_url('admin/update_stunting'); ?>">
                       <div class="row mb-3">
                          <div class="col">
                          <input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
                            <label>Kecamatan</label>
                           <select name="kec" class="custom-select form-control-sm" required>
                           <option value="<?php echo $data['id_kecamatan']; ?>">Pilihan</option>
                          ...
                          <div class="col">
                            ...
                            <input type="text" class="form-control form-control-sm" name="puskesmas" value="<?php echo $data['puskesmas']; ?>" required autofocus>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col">
                            <label>Jumlah Balita Laki-laki</label>
                           <input type="email" class="form-control form-control-sm" name="j_bl" value="<?php echo $data['balita_laki']; ?>" required autofocus>
                          </div>
                          <div class="col">
                            <label>Jumlah Balita Perempuan</label>
                            <input type="text" class="form-control form-control-sm" name="j_bp" value="<?php echo $data['balita_perempuan']; ?>"  required autofocus>
                          </div>
                        </div>
                        <div class="row mb-4">
                          <div class="col">
                            <label>Jumlah Balita Laki-laki di ukur</label>
                            <input type="number" class="form-control form-control-sm" name="j_blu" value="<?php echo $data['balita_ukur_l']; ?>" required autofocus>
                          </div>
                          <div class="col">
                            <label>Jumlah Balita Perempuan di ukur</label>
                            <input type="number" class="form-control form-control-sm" name="j_bpu" value="<?php echo $data['balita_ukur_p']; ?>" required autofocus>
                          </div>
                        </div>
                        <div class="row mb-3">
                         <div class="col">
                            <label>Jumlah Balita Stunted laki</label>
                            <input type="number" class="form-control form-control-sm" name="j_bsl" value="<?php echo $data['stuted_l']; ?>" required autofocus>
                          </div>
                          <div class="col">
                            <label>Jumlah Balita Stunted Perempuan</label>
                            <input type="number" class="form-control form-control-sm" name="j_bsp" value="<?php echo $data['stunted_p']; ?>" required autofocus>
                          </div>
                        </div>
                        <div class="row mb-4">
                         ...
                         <div class="col">
                            <label>Tahun</label>
                            <select name="title" class="custom-select form-control-sm" required>
                            <option><?php echo $data['tahun']; ?></option>
                             <option value="2016">2016</option>
                             <option value="Mr">2017</option>
                             <option value="Mrs">2018</option>
                             <option value="Ms">2019</option>
                           </select>
                          </div>
                        </div>
