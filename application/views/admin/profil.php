    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-user"></i> Profil Page</div>
        <div class="card-body">
			<section class="row">                         
    <div class="col-12">
      <h5 class="color-secondary text-center">Perbarui Profil</h5>
    </div>
    <div class="col-4 offset-4 border ">
      <form id="member-dashboard-password-form" method="post" action="<?php echo site_url('admin/update_profil/') .$param['username']; ?>">
        <div class="row mb-3">
          <div class="col">
            <label>Nama</label>
            <input type="text" class="form-control form-control-sm" name="nama" value="<?php echo $nama; ?>" required autofocus>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col">
            <label>Username</label>
            <input type="text" class="form-control form-control-sm" name="username" value="<?php echo $param['username']; ?>" required autofocus>
          </div>
          <div class="col">
            <label>Password</label>
            <input type="password" class="form-control form-control-sm" name="password" value="<?php echo $param['password']; ?>" required autofocus>
          </div>
        </div>
        <div class="clearfix mb-1">
          <button type="submit" class="btn btn-outline-primary float-right">Perbaharui</button>
        </div>
      </form>
    </div>
  </section>
