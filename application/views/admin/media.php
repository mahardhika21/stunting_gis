  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kelola Tentang</li>
      </ol>
      <!-- Area Chart Example-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-globe"></i> Kelola Deskripsi Web</div>
        <div class="card-body">
      <section class="row">                         
    <div class="col-12">
      <h5 class="color-secondary text-center">Deskripsi Web</h5>
    </div>
    <div class="col-10 offset-1 border ">
      <form id="member-dashboard-password-form" method="post" action="<?php echo site_url('admin/up_about'); ?>">
        
        <div class="row mb-10">
          <div class="col">
            <label>Deskripsi Web</label>
            <textarea name="about" class="form-control" rows="5"><?php echo $about['about']; ?></textarea>
          </div>
          
        </div>
        <div class=" mt-1 mb-1">
          <button type="submit" class="btn btn-info float-right">Update Deskripsi</button>
        </div>
      </form>
    </div>
      <div class="col-10 offset-1 border ">
      <form id="member-dashboard-password-form" method="post" action="<?php echo site_url('admin/up_gizi'); ?>">
        <div class="row mb-10">
          <div class="col">
            <label>Informasi Kebutuhan Gizi</label>
            <textarea name="gizi" class="form-control" rows="5"><?php echo $about['gizi']; ?></textarea>
          </div>
          
        </div>
        <div class=" mt-1 mb-1">
          <button type="submit" class="btn btn-info float-right">Update Informasi Nilai Gizi</button>
        </div>
      </form>
    </div>
  </section>
