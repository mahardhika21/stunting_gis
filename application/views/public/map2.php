...
<body class="bg-light">
    ...
    <div class="container">
     ...
     <div  <?php if($param == 0){ echo 'hidden'; }?>>
      ...
      <form method="" action="<?php echo site_url('Gis/grafik'); ?>">
       <div class="form-row">
          <div class="col-12">
          <select class="form-control form-control-sm" name="tahun" id="tahun" onchange="tahun()">
  ...
  <div class="card-header font-weight-bold text-center">Peta Kabupaten Sleman</div>
...
<div class="row mt-2">
  ...
  info.update = function (props) {
    this._div.innerHTML = '<h4>Data Stunting(gizi Buruk) Kabupaten Sleman</h4>';
  };
  info.addTo(map);
  function getColor(d) {
...
var m = L.marker([-7.7338888888889, 110.32888888889], {draggable:true}).bindLabel('Mlati', { noHide: true })
      .addTo(map);
var m = L.marker([-7.8052777777778, 110.44277777778], {draggable:true}).bindLabel('Berbah', { noHide: true })
      .addTo(map);
var m = L.marker([-7.6588888888889, 110.45611111111], {draggable:true}).bindLabel('Cangkringan', { noHide: true })
      .addTo(map);
var m = L.marker([-7.7583333333333, 110.39361111111], {draggable:true}).bindLabel('Depok', { noHide: true })
      .addTo(map);

var m = L.marker([-7.7955555555556, 110.32166666667], {draggable:true}).bindLabel('Gamping', { noHide: true })
      .addTo(map);
var m = L.marker([-7.7697222222222, 110.29972222222], {draggable:true}).bindLabel('Godean', { noHide: true })
      .addTo(map);
var m = L.marker([-7.77, 110.46694444444], {draggable:true}).bindLabel('Kalasan', { noHide: true })
      .addTo(map);

var m = L.marker([-7.7255555555556, 110.23472222222], {draggable:true}).bindLabel('Minggir', { noHide: true })
      .addTo(map);
var m = L.marker([-7.7727777777778, 110.25361111111], {draggable:true}).bindLabel('Moyudan', { noHide: true })
      .addTo(map);


var m = L.marker([-7.7238888888889, 110.40083333333], {draggable:true}).bindLabel('Ngaglik', { noHide: true })
      .addTo(map);
var m = L.marker([-7.6977777777778, 110.445], {draggable:true}).bindLabel('Ngemplak', { noHide: true })
      .addTo(map);
var m = L.marker([-7.6669444444444, 110.42], {draggable:true}).bindLabel('Pakem', { noHide: true })
      .addTo(map);

var m = L.marker([-7.7563888888889, 110.49], {draggable:true}).bindLabel('Prambanan', { noHide: true })
      .addTo(map);
var m = L.marker([-7.7211111111111, 110.30805555556], {draggable:true}).bindLabel('Seyegan', { noHide: true })
      .addTo(map);
var m = L.marker([-7.6836111111111, 110.34027777778], {draggable:true}).bindLabel('Sleman ', { noHide: true })
      .addTo(map);

var m = L.marker([-7.6522222222222, 110.32638888889], {draggable:true}).bindLabel('Tempel)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.6519444444444, 110.36972222222], {draggable:true}).bindLabel('Turi', { noHide: true })
      .addTo(map);
//*/
