...
<body class="bg-light">
        ...
        <div class="col-md-12">
			<div class="card mt-4 p-4" style="">
				  <div class="card-body">
					...
					<p class="card-text"><?php echo $about['about']; ?></p>

					<div class="d-flex flex-row-reverse">
					  <div class="p-2"><a class="btn btn-primary btn-sm fotn-light">Liat Map Stundting</a></div>
					  <div class="p-2"><a class="btn btn-primary btn-sm">Liat Map Grafik</a></div>
				   </div>
				  </div>
</div>
        </div>
  ...
  <div class="py-0 bg-dark text-white <?php if(strlen($about['about']) <= 1600){ echo 'fixed-bottom';} ?>">
    <div class="container">
      <div class="row">
