...
<div class="card border-primary mt-2" style="max-width: 80rem;">
  <div class="card-body m-0 p-0">
      <div class="d-flex flex-row-reverse m-0">
            ...
            <div class="p-2">
                 <a href="j;jjjjjjj;;jj" class="btn btn-sm btn-danger float-right" id="pdf">Download Laporan <i class="fa fa-download"></i></a>
            </div>
...
<div class="row mt-2">
  ...
  info.update = function (props) {
    this._div.innerHTML = '<h4>Data Stunting(gizi Buruk) Kabupaten Sleman</h4>' +  (props ?
...
var m = L.marker([-7.730625, 110.336839], {draggable:true}).bindLabel('Mlati ('+ <?php echo ceil($persen_mlati); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.807560, 110.456758], {draggable:true}).bindLabel('Berbah ('+ <?php echo ceil($persen_berbah); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.632309, 110.456001], {draggable:true}).bindLabel('Cangkringan ('+ <?php echo ceil($persen_cangkringan); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.768212, 110.408334], {draggable:true}).bindLabel('Depok ('+ <?php echo ceil($persen_depok); ?> +' %)', { noHide: true })
      .addTo(map);

var m = L.marker([-7.792943, 110.324924], {draggable:true}).bindLabel('Gamping ('+ <?php echo ceil($persen_gamping); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.767382, 110.293104], {draggable:true}).bindLabel('Godean ('+ <?php echo ceil($persen_godean); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.739839, 110.461959], {draggable:true}).bindLabel('Kalasan ('+ <?php echo ceil($persen_kalasan); ?> +' %)', { noHide: true })
      .addTo(map);

var m = L.marker([-7.729886, 110.247479], {draggable:true}).bindLabel('Minggir ('+ <?php echo ceil($persen_minggir); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.771050, 110.247479], {draggable:true}).bindLabel('Moyudan ('+ <?php echo ceil($persen_moyudan); ?> +' %)', { noHide: true })
      .addTo(map);


var m = L.marker([-7.717399, 110.396418], {draggable:true}).bindLabel('Ngaglik ('+ <?php echo ceil($persen_ngaglik); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.704174, 110.456001], {draggable:true}).bindLabel('Ngemplak ('+ <?php echo ceil($persen_ngemplak); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.639487, 110.414292], {draggable:true}).bindLabel('Pakem ('+ <?php echo ceil($persen_pakem); ?> +' %)', { noHide: true })
      .addTo(map);

var m = L.marker([-7.799136, 110.509628], {draggable:true}).bindLabel('Prambanan ('+ <?php echo ceil($persen_prambanan); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.722105, 110.301094], {draggable:true}).bindLabel('Seyegan ('+ <?php echo ceil($persen_seyegan); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.680775, 110.357691], {draggable:true}).bindLabel('Sleman ('+ <?php echo ceil($persen_sleman); ?> +' %)', { noHide: true })
      .addTo(map);

var m = L.marker([-7.664695, 110.318966], {draggable:true}).bindLabel('Tempel ('+ <?php echo ceil($persen_tempel); ?> +' %)', { noHide: true })
      .addTo(map);
var m = L.marker([-7.625549, 110.384502], {draggable:true}).bindLabel('Turi ('+ <?php echo ceil($persen_turi); ?> +' %)', { noHide: true })
      .addTo(map);
//*/
